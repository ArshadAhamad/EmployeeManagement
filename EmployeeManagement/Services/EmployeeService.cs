...
namespace EmployeeManagement.Services
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public List<EmployeeDTO> GetAllEmployees()
        {
            ...
            if (employees != null & employees.Count > 0)
            {
                foreach (Employee entity in employees)
                {
                    ...
                    employeeDTO.Salary = entity.Salary.ToString();
                    employeeDTO.DepartmentId = entity.Department.DepartmentId.ToString();
        ...
        public Employee AddEmployee(EmployeeDTO employeeDTO)
        {
            ...
            entity.Salary = Convert.ToDouble(employeeDTO.Salary);
            entity.DepartmentId = Convert.ToInt32(employeeDTO.DepartmentId);  
